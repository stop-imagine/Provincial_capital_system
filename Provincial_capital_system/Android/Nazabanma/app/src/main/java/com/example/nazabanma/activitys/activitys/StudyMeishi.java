...
public class StudyMeishi extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_study_meishi);
        init();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_play:
                ...
                if (btnPlayFlay%2==1) {
                    play.setText("暂停");
                    Toast.makeText(StudyMeishi.this,"当前速度为:"+speed/1000+"秒一次",Toast.LENGTH_SHORT).show();
                    startTimer();
                }
                else{
                    play.setText("开始");
    ...
    private void parseJSONWithGSON(String jsonData) {
        ...
        meishi = sh.getMeishi();
        Log.d("Jingdian", "id is " + GlideFlag);
        Log.d("Jingdian", "huiming is " + huiming);
        Log.d("Jingdian", "meishi is " + meishi);
    }
}
