...
public class StudyJingdian extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_study_jingdian);
        init();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_play:
                ...
                if (btnPlayFlay%2==1) {
                    play.setText("暂停");
                    Toast.makeText(StudyJingdian.this,"当前速度为:"+speed/1000+"秒一次",Toast.LENGTH_SHORT).show();
                    startTimer();
                }
                else{
                    play.setText("开始");
