 ...
 */
public class f_manager_zengjia extends Fragment{



    private EditText et1, et2, et3, et4, et5;
    private Button button1;
    public f_manager_zengjia() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_manager_zengjia, container, false);
    }
    ...
    public void onActivityCreated(Bundle saveInstanceState) {
        ...
        button1 = getActivity().findViewById(R.id.btn_zengjia);
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String address = "http://111.231.141.166:80/shkp_system_war/AddServlet";
                ...
                addWithOkHttp(address,addShengming,addHuiming,addMeishi,addJingdian,addGaoxiao);
            }
        });
    }

    private void addWithOkHttp(String address, String addShengming, String addHuiming, String addMeishi, String addJingdian, String addGaoxiao) {
        HttpUtil.addWithOkHttp(address, addShengming, addHuiming, addMeishi, addJingdian, addGaoxiao, new Callback() {
            @Override
